...
RUN_NAME = "result_pretrained_new"
...
# ----------------------------
def save_summary_from_val(val_res, save_dir: Path, best_epoch=None, best_map_curve=None):
    ...
    summary = {
        ...
        "best_map_curve": float(best_map_curve) if best_map_curve is not None else None,
...
def main():
    ...
    # 1) training curve
    best_epoch, best_map_curve = plot_map_curve(results_csv)
    ...
    save_summary_from_val(val_res, save_dir, best_epoch, best_map_curve)
